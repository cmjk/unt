...
class TestSearch:
    ...
    def test_sort_by(search: pytest.fixture, actions: Actions, search_query: str, order_by: OrderBy, expected: list[ProductItem]):
    ...
    def test_redirect_to_product_page(search: pytest.fixture, actions: Actions, search_query: str, locator: tuple, link_to_product: str):
